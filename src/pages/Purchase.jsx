...
export default function Purchase() {
  ...
  return (
    <>
      <div className="lg:ms-[18%] lg:w-[82%] bg-[#F4F6F8] w-full  mt-16">
            ...
            {data.length > 0 && (
              <>
                ...
                <div className="flex flex-row text-[#00900D] items-center gap-1 mt-2">
                  ...
                  <p className=" text-sm mx-1 mb-0 ">
                    {data[0].indent[0].status}
                  </p>
            ...
            <div className="w-[300px] flex flex-col gap-3">
              {data?.map((item, i) => (
                <div className="w-full bg-white p-2 rounded-lg">
                  ...
                  <Link
                    to={serverDomain + "/" + item?.indent[0]?.fileUrl}
                    className="flex items-center gap-2"
                  >
                    <img src="/pdf.png" alt="" />
            ...
            <div className="w-[300px] flex flex-col gap-3">
              ...
              {data.map((item, i) => (
                ...
                >
                  ...
                  <Link
                    to={serverDomain + "/" + item?.purchaseOrder[0]?.fileUrl}
                    className="flex items-center gap-2"
                  >
                    <img src="/pdf.png" alt="" />
