...
export default function Planning() {
  ...
  const handleChangeFile2 = ({ fileList: newFileList }) => {
    if (isFileAllowed) {
      setFileList2(newFileList);
    }
  };
  const handleChangeFile3 = ({ fileList: newFileList }) => {
    if (isFileAllowed) {
    ...
    (async () => {
      try {
        const res = await axios.get(
          `${serverDomain}/planning/details/${projectId}`,
          {
            headers: {
              Authorization: authToken,
            },
  ...
  return (
    <>
      <div className="lg:ms-[18%] lg:w-[82%] bg-[#F4F6F8] w-full  mt-14">
                  ...
                  <div className="flex flex-row text-[#00900D] justify-between items-center gap-1 mt-2">
                    <div className=" flex flex-row">
                      ...
                      <p className=" text-xs mx-1 mb-0 ">
                        {formData.tds[0].status ? "Approved" : "Pending"}
                      </p>
                    </div>
                    ...
                    onChange={() =>
                      setFormData({
                        ...
                        approvedDesign: [
                          {
                            ...formData.approvedDesign[0],
                            status: !formData.approvedDesign[0].status,
                          },
                        ],
                      })
                    }
                    checked={formData.approvedDesign[0].status}
                  ></Checkbox>
                ...
                <div>
                  ...
                  <div className="flex flex-row text-[#00900D] justify-between items-center gap-1 mt-2">
                    <div className=" flex flex-row">
                      <FiCheckCircle className=" text-xs" />
                      <p className=" text-xs mx-1 mb-0 ">
                        {formData.approvedDesign[0].status
                          ? "Approved"
                          : "Pending"}
                      </p>
                    </div>
                    ...
                    onChange={() =>
                      setFormData({
                        ...
                        amendmentBoq: [
                          {
                            ...formData.amendmentBoq[0],
                            status: !formData.amendmentBoq[0].status,
                          },
                        ],
                      })
                    }
                    checked={formData.amendmentBoq[0].status}
                  ></Checkbox>
                ...
                <div>
                  ...
                  <div className="flex flex-row text-[#00900D] justify-between items-center gap-1 mt-2">
                    <div className=" flex flex-row">
                      <FiCheckCircle className=" text-xs" />
                      <p className=" text-xs mx-1 mb-0 ">
                        {formData.amendmentBoq[0].status
                          ? "Approved"
                          : "Pending"}
                      </p>
                    </div>
                    ...
                    onChange={() =>
                      setFormData((prev) => ({
                        ...
                        poComparison: [
                          {
                            ...prev.poComparison[0],
                            status: !prev.poComparison[0].status,
                          },
                        ],
                      }))
                    }
                    checked={formData.poComparison[0].status}
                  ></Checkbox>
                ...
                <div>
                  ...
                  <div className="flex flex-row text-[#00900D] justify-between items-center gap-1 mt-2">
                    <div className=" flex flex-row">
                      <FiCheckCircle className=" text-xs" />
                      <p className=" text-xs mx-1 mb-0 ">
                        {formData.poComparison[0].status
                          ? "Approved"
                          : "Pending"}
                      </p>
                    </div>
                    ...
                    onChange={() =>
                      setFormData((prev) => ({
                        ...
                        boqComment: [
                          {
                            ...prev.boqComment[0],
                            status: !prev.boqComment[0].status,
                          },
                        ],
                      }))
                    }
                    ...
                    onChange={(e) =>
                      setFormData({
                        ...
                        lotWiseDistribution: [
                          {
                            ...formData.lotWiseDistribution[0],
                            status: !formData.lotWiseDistribution[0].status,
                          },
                        ],
                      })
                    }
                ...
                <div>
                  ...
                  <div className="flex flex-row text-[#00900D] justify-between items-center gap-1 mt-2">
                    <div className=" flex flex-row">
                      <FiCheckCircle className=" text-xs" />
                      <p className=" text-xs mx-1 mb-0 ">
                        {formData.lotWiseDistribution[0].status
                          ? "Approved"
                          : "Pending"}
                      </p>
                    </div>
                    ...
                    onChange={(e) =>
                      setFormData({
                        ...
                        indent: [
                          {
                            ...formData.indent[0],
                            status: !formData.indent[0].status,
                          },
                        ],
                      })
                    }
                ...
                <div className=" h-[60px]">
                  ...
                  <div className="flex flex-row text-[#00900D] justify-between items-center gap-1 mt-10">
                    <div className=" flex flex-row">
                      <FiCheckCircle className=" text-xs" />
                      <p className=" text-xs mx-1 mb-0 ">
                        {formData.indent[0].status ? "Approved" : "Pending"}
                      </p>
                    </div>
                    {/* <p className=" text-[#828282] text-xs">on Nov 16, 2023</p> */}
                    <input
                  ...
                  <Checkbox
                    onChange={(e) =>
                      setFormData({
                        ...
                        indentComment: [
                          {
                            ...formData.indentComment[0],
                            status: !formData.indentComment[0].status,
                          },
                        ],
                      })
                    }
            ...
            <div className="w-[270px] flex flex-col gap-6">
              <div className="w-full rounded-l-lg min-h-[200px] flex flex-col justify-between bg-white  p-2 ">
                <div>
                  ...
                  {listData?.tds && (
                    <Link to={listData?.tds[0]?.fileUrl}>
                      <div className="flex gap-2 flex-row items-center relative">
                        <img src="/pdf.png" alt="pdf" />
                        <p className="truncate w-[120px]">
                          {listData?.tds[0]?.fileUrl}
                        </p>
                      </div>
                    </Link>
                  )}
              ...
              <div className="w-full min-h-[200px] flex flex-col justify-between bg-white  p-2 ">
                <div>
                  ...
                  {listData?.approvedDesign && (
                    <Link to={listData?.approvedDesign[0]?.fileUrl}>
                      <div className="flex gap-2 flex-row items-center relative">
                        <img src="/pdf.png" alt="pdf" />
                        <p className="truncate w-[120px]">
                          {listData?.approvedDesign[0]?.fileUrl}
                        </p>
                      </div>
                    </Link>
                  )}
              ...
              <div className="w-full min-h-[200px] flex flex-col justify-between bg-white  p-2 ">
                <div>
                  ...
                  {listData?.amendmentBoq && (
                    <Link to={listData?.amendmentBoq[0]?.fileUrl}>
                      <div className="flex gap-2 flex-row items-center relative">
                        <img src="/pdf.png" alt="pdf" />
                        <p className="truncate w-[120px]">
                          {listData?.amendmentBoq[0]?.fileUrl}
                        </p>
                      </div>
                    </Link>
                  )}
            ...
            <div className="w-[270px] flex flex-col gap-6">
              <div className="w-full min-h-[200px] flex flex-col justify-between bg-white  p-2 ">
                <div className=" h-[60px]">
                  ...
                  {listData?.indent && listData?.indent[0]?.fileUrl && (
