...
export default function Teams() {
  ...
  const factoryTeam = teams?.filter((team) => team.roleInCompany === "FACTORY");
  const purchaseTeam = teams?.filter((team) => team.roleInCompany === "PURCHASE");
  const plannerTeam = teams?.filter((team) => team.roleInCompany === "PLANNER");
  useEffect(() => {
    (async () => {
      try {
        ...
        const res = await axios.get(
          `${serverDomain}/employee/list?page=1&limit=80`,
          {
            headers: {
  ...
  return (
    <>
      <div className="lg:ms-[18%] lg:w-[82%] mt-20 w-full  md:p-10 px-2 !py-0 bg-[#F4F6F8] ">
        ...
        <div className=" w-full bg-white py-4 ms:px-8 px-2 rounded-xl mt-4">
          <h2 className=" text-[#306BFF] underline text-xl font-medium">
            Project Name
          </h2>
          ...
          <div className="w-full flex flex-row lg:flex-nowrap flex-wrap gap-5 my-5">
            <div className=" overflow-x-scroll lg:w-full">
              <div className="lg:w-full min-w-[400px] md:p-3 p-2 bg-[#F4F6F8] rounded-lg">
                <div className="w-full flex flex-row justify-between">
                  <h4 className="text-[#06152B] font-medium">Senior Team</h4>
                  <AiOutlinePlus onClick={() => navigate("/add-team")} className="text-[#053BD3] text-lg font-bold cursor-pointer" />
                </div>
                <div className="w-full flex flex-row justify-between gap-2 p-5">
                  <div className=" w-[55%] text-xs ">Name</div>
            ...
            <div className=" overflow-x-scroll w-full">
              <div className="lg:w-full min-w-[400px] md:p-3 p-2 bg-[#F4F6F8] rounded-lg">
                <div className="w-full flex flex-row justify-between">
                  <h4 className="text-[#06152B] font-medium">Planning Team</h4>
                  <AiOutlinePlus onClick={() => navigate("/add-team")} className="text-[#053BD3] text-lg font-bold cursor-pointer" />
                </div>
                <div className="w-full flex flex-row justify-between gap-2 p-5">
                  <div className=" w-[55%] text-xs ">Name</div>
        ...
        <div className=" w-full bg-white py-4 ms:px-8 px-2 rounded-xl mt-4">
          ...
          <div className="w-full flex flex-row lg:flex-nowrap flex-wrap gap-5 my-5">
            <div className=" overflow-x-scroll lg:w-full">
              <div className="lg:w-full min-w-[400px] md:p-3 p-2 bg-[#F4F6F8] rounded-lg">
                <div className="w-full flex flex-row justify-between">
                  <h4 className="text-[#06152B] font-medium">Factory Team</h4>
                  <AiOutlinePlus onClick={() => navigate("/add-team")} className="text-[#053BD3] text-lg font-bold cursor-pointer" />
                </div>
                <div className="w-full flex flex-row justify-between gap-2 p-5">
                  <div className=" w-[55%] text-xs ">Name</div>
            ...
            <div className=" overflow-x-scroll w-full">
              <div className="lg:w-full min-w-[400px] md:p-3 p-2 bg-[#F4F6F8] rounded-lg">
                <div className="w-full flex flex-row justify-between">
                  <h4 className="text-[#06152B] font-medium">Purchase Team</h4>
                  <AiOutlinePlus onClick={() => navigate("/add-team")} className="text-[#053BD3] text-lg font-bold cursor-pointer" />
                </div>
                <div className="w-full flex flex-row justify-between gap-2 p-5">
                  <div className=" w-[55%] text-xs ">Name</div>
