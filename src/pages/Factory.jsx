                  ...
                  <div className="w-full flex flex-row gap-3 items-center justify-start">
                    ...
                    <div className=" w-[30%] h-[50px] bg-[#fafafa] rounded-lg border-dashed p-4 border border-[#B5BBC2]">
                      ...
                      <input
                        ...
                        className="outline-none w-full"
                        value={
                          formData.shearing.totalQuantity -
                          formData.shearing.done
                        }
                        // onChange={(e) => {
                        //   setFormData({
                        //     ...formData,
                  ...
                  <div className="w-full flex flex-row gap-3 items-center justify-start">
                    ...
                    <div className=" w-[30%] h-[50px] bg-[#fafafa] rounded-lg border-dashed p-4 border border-[#B5BBC2]">
                      ...
                      <input
                        ...
                        className="outline-none w-full"
                        value={
                          formData.cutToLength.totalQuantity -
                          formData.cutToLength.done
                        }
                        // onChange={(e) => {
                        //   setFormData({
                        //     ...formData,
                  ...
                  <div className="w-full flex flex-row gap-3 items-center justify-start">
                    ...
                    <div className=" w-[30%] h-[50px] bg-[#fafafa] rounded-lg border-dashed p-4 border border-[#B5BBC2]">
                      ...
                      <input
                        ...
                        className="outline-none w-full"
                        value={
                          formData.bending.totalQuantity - formData.bending.done
                        }
                        // onChange={(e) => {
                        //   setFormData({
                        //     ...formData,
                  ...
                  <div className="w-full flex flex-row gap-3 items-center justify-start">
                    ...
                    <div className=" w-[30%] h-[50px] bg-[#fafafa] rounded-lg border-dashed p-4 border border-[#B5BBC2]">
                      ...
                      <input
                        ...
                        className="outline-none w-full"
                        value={
                          formData.powderCoating.totalQuantity -
                          formData.powderCoating.done
                        }
                        // onChange={(e) => {
                        //   setFormData({
                        //     ...formData,
                  ...
                  <div className="w-full flex flex-row gap-3 items-center justify-start">
                    ...
                    <div className=" w-[30%] h-[50px] bg-[#fafafa] rounded-lg border-dashed p-4 border border-[#B5BBC2]">
                      ...
                      <input
                        ...
                        className="outline-none w-full"
                        value={
                          formData.assembly.totalQuantity -
                          formData.assembly.done
                        }
                        // onChange={(e) => {
                        //   setFormData({
                        //     ...formData,
                  ...
                  <div className="w-full flex flex-row gap-3 items-center justify-start">
                    ...
                    <div className=" w-[30%] h-[50px] bg-[#fafafa] rounded-lg border-dashed p-4 border border-[#B5BBC2]">
                      ...
                      <input
                        ...
                        className="outline-none w-full"
                        value={
                          formData.puffingAndPressing.totalQuantity -
                          formData.puffingAndPressing.done
                        }
                        // onChange={(e) => {
                        //   setFormData({
                        //     ...formData,
                  ...
                  <div className="w-full flex flex-row gap-3 items-center justify-start">
                    ...
                    <div className=" w-[30%] h-[50px] bg-[#fafafa] rounded-lg border-dashed p-4 border border-[#B5BBC2]">
                      ...
                      <input
                        ...
                        className="outline-none w-full"
                        value={
                          formData.qualityCheck.totalQuantity -
                          formData.qualityCheck.done
                        }
                        // onChange={(e) => {
                        //   setFormData({
                        //     ...formData,
                  ...
                  <div className="w-full flex flex-row gap-3 items-center justify-start">
                    ...
                    <div className=" w-[30%] h-[50px] bg-[#fafafa] rounded-lg border-dashed p-4 border border-[#B5BBC2]">
                      ...
                      <input
                        ...
                        className="outline-none w-full"
                        value={
                          formData.packaging.totalQuantity -
                          formData.packaging.done
                        }
                        // onChange={(e) => {
                        //   setFormData({
                        //     ...formData,
                  ...
                  <div className="w-full flex flex-row gap-3 items-center justify-start">
                    ...
                    <div className=" w-[30%] h-[50px] bg-[#fafafa] rounded-lg border-dashed p-4 border border-[#B5BBC2]">
                      ...
                      <input
                        ...
                        className="outline-none w-full"
                        value={
                          formData.dispatch.totalQuantity -
                          formData.dispatch.done
                        }
                        // onChange={(e) => {
                        //   setFormData({
                        //     ...formData,
