      ...
      <div className="lg:ms-[18%] lg:w-[82%] mt-14 w-full  md:p-10 px-3 py-10 bg-[#F4F6F8] ">
        <div className=" w-full flex flex-row gap-5 my-5 overflow-x-scroll">
          <div className="w-full min-w-[1000px] p-3 bg-[#F4F6F8] rounded-lg">
            <div className="w-full flex flex-row justify-between gap-2 p-3">
              <div className="w-[10%] text-xs">Project ID</div>
              <div className="w-[20%] text-xs">Name</div>
              <div className="w-[15%] text-xs">Email</div>
              <div className="w-[15%] text-xs">Phone Number</div>
              <div className="w-[15%] text-xs">Company Name</div>
              <div className="w-[15%] text-xs">Date Added</div>
              <div className="w-[10%] text-xs">Password</div>
            </div>

            {clients?.map((client) => (
              <div className="w-full flex flex-row justify-between my-2 gap-2 bg-white items-center p-3 rounded-xl">
                <div className="w-[10%] text-sm text-[#06152B]">
                  {projectId || 0}
                </div>
                <div className="w-[20%] text-xs  flex flex-row items-center gap-2">
                ...
                <div className="w-[15%] text-xs flex items-center">
                  {client.email}
                </div>
                <div className="w-[15%] text-xs flex items-center">
                  {client.phoneNumber}
                ...
                <div className="w-[15%] text-xs flex flex-row justify-between items-center">
                  {client.date.split("-").join("/")}
                </div>
                <div className="w-[10%] text-xs flexi tems-center">
                  {client.password}
                </div>
