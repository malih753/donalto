...
export default function Dashboard() {
  ...
  const { search, projectId, setProjectId, setClientName } = useJobContext();
  // const { } = useProjectIdContext();
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        setSelectedProject(items?.[0].label);
      } catch (error) {
        console.log(error);
      }
    })();
          ...
          <Dropdown
            menu={{
              ...
              onClick: (e) => {
                ...
                setSelectedProject(e.domEvent.target.innerText);
                setProjectId(e.key);
                console.log(e.key);
                const selectedClient = projectLists.find((c) => c.key == e.key)
        ...
        <div className="w-full flex flex-row gap-5  lg:flex-nowrap flex-wrap items-start justify-between">
          ...
          <div className=" bg-white rounded-lg p-5 lg:w-[40%] w-full justify-between flex flex-col gap-2">
            ...
            <div className=" w-full flex flex-row flex-wrap gap-3 items-center my-5">
              <button
                onClick={() => {
                  setPercentage({ percentage: data?.salesTeam.percentage }),
                    setselectedButton(1);
                }}
                style={{
                  backgroundColor: selectedButton == 1 ? "#306BFF" : "#ffffff",
                  color: selectedButton == 1 ? "#ffffff" : "#306BFF",
                }}
              ...
              <button
                onClick={() => {
                  setPercentage({ percentage: data?.designTeam?.percentage }),
                    setselectedButton(2);
                }}
                style={{
                  backgroundColor: selectedButton == 2 ? "#306BFF" : "#ffffff",
                  color: selectedButton == 2 ? "#ffffff" : "#306BFF",
                }}
              ...
              <button
                onClick={() => {
                  setPercentage({ percentage: data?.factoryTeam?.percentage }),
                    setselectedButton(3);
                }}
                style={{
                  backgroundColor: selectedButton == 3 ? "#306BFF" : "#ffffff",
                  color: selectedButton == 3 ? "#ffffff" : "#306BFF",
                }}
                className=" w-[170px] items-center font-medium p-3 h-full border border-[#306BFF]  rounded-lg flex flex-row gap-2 "
              >
              ...
              <button
                onClick={() => {
                  setPercentage({ percentage: data?.planningTeam?.percentage }),
                    setselectedButton(4);
                }}
                style={{
                  backgroundColor: selectedButton == 4 ? "#306BFF" : "#ffffff",
                  color: selectedButton == 4 ? "#ffffff" : "#306BFF",
                }}
                className=" w-[170px] items-center font-medium p-3 h-full border border-[#306BFF]  rounded-lg flex flex-row gap-2 "
              >
